...
public class CriandoListaImportantPage {

	public CriandoListaImportantPage() {
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@text='Important']")
	private MobileElement botao_important;
	public void clicarBotaoimportant() {
		botao_important.click();
	}

	@AndroidFindBy(xpath = "//android.widget.ImageButton[@resource-id='com.microsoft.todos:id/new_todo_fab']")
	private MobileElement botao_adicionar_important;
	public void clicarBotaoAdicionarimportanty() {
		botao_adicionar_important.click();
	}
