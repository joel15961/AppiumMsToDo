...
public class CriandoListaplanedPage {
	public CriandoListaplanedPage() {
	...
	private MobileElement botao_Planned;
	public void clicarBotaoPlanned() {
		botao_Planned.click();
	}

	@AndroidFindBy(xpath = "//android.widget.ImageButton[@resource-id='com.microsoft.todos:id/new_todo_fab']")
	private MobileElement botao_adicionar_Planned;
	public void clicarBotaoAdicionarPlanned() {
		botao_adicionar_Planned.click();
	}
